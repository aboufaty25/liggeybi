  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans pb-20">
      ...
      <div className="container mx-auto px-4 -mt-6 md:-mt-8 relative z-20 max-w-6xl">
        ...
        {/* Create an alert box (Wide Banner at bottom) */}
        <div className="bg-gradient-to-r from-[#128C7E] to-[#25D366] rounded-2xl md:rounded-3xl p-6 md:p-10 text-white shadow-2xl shadow-emerald-600/30 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 mb-16">
           <div className="absolute -left-12 -bottom-12 text-white/5 pointer-events-none">
             <svg viewBox="0 0 24 24" fill="currentColor" className="w-48 h-48 md:w-64 md:h-64"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51a12.8 12.8 0 0 0-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413z"/></svg>
           </div>
           
           <div className="relative z-10 flex flex-col md:flex-row items-center gap-4 md:gap-8 text-center md:text-left">
             <div className="hidden md:flex bg-white/20 w-24 h-24 rounded-[2rem] items-center justify-center shrink-0 shadow-inner">
               <svg viewBox="0 0 24 24" fill="currentColor" className="w-12 h-12 text-white"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51a12.8 12.8 0 0 0-.57-.01c-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 0 1-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 0 1-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 0 1 2.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0 0 12.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 0 0 5.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 0 0-3.48-8.413z"/></svg>
             </div>
             <div>
               <h3 className="text-2xl md:text-4xl font-black mb-2 md:mb-4 text-white tracking-tight">Rejoignez-nous</h3>
               <p className="text-emerald-50 text-sm sm:text-base md:text-xl leading-relaxed max-w-2xl font-medium">Recevez directement sur WhatsApp les dernières offres correspondant à votre profil dès leur publication sur le site.</p>
             </div>
           </div>
           
           <div className="relative z-20 w-full md:w-auto shrink-0">
           <a href={siteConfig.whatsapp_channel_url || "https://whatsapp.com/channel/0029Vb5e4tw4inotGoAu0A0r"} target="_blank" rel="noopener noreferrer" className="block w-full">
               <Button className="w-full md:w-auto bg-white hover:bg-slate-50 text-[#075E54] font-black h-14 md:h-20 px-8 md:px-12 rounded-xl md:rounded-2xl shadow-xl text-sm md:text-lg transition-transform hover:scale-105 flex items-center justify-center gap-2">
